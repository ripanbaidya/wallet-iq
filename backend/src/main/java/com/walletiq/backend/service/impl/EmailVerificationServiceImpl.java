...
import com.walletiq.backend.entity.EmailVerificationOtp;
import com.walletiq.backend.entity.User;
import com.walletiq.backend.enums.ErrorCode;
import com.walletiq.backend.exception.OtpException;
import com.walletiq.backend.exception.UserException;
import com.walletiq.backend.repository.EmailVerificationOtpRepository;
...
import static com.walletiq.backend.util.MaskingUtil.maskEmail;
